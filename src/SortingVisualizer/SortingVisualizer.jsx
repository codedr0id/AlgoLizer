...
export default class SortingVisualizer extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            DelayTimesSizeBased: {'fast': [15, 20, 20, 40, 40], 'median': [30, 40, 40, 80, 80], 'slow': [80, 100, 100, 200, 200]},
            ...
            <>
                ...
                <div class="d-flex" style={{marginLeft: "37%", marginTop: "10px"}}>
                    <div class="dropdown 1">
                        <button class="btn btn-outline-dark dropdown-toggle" type="button" disabled={this.state.rendering} id="dropdownMenuSpeed" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style={{ marginLeft: "35px", marginRight: "5px", height: "30px", width: "150px" }}>
                    ...
                    <div class="dropdown 1">
                        <button class="btn btn-outline-dark dropdown-toggle" type="button" disabled={this.state.rendering} id="dropdownMenuSize" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style={{ marginLeft: "20px", height: "30px", width: "150px" }}>
                ...
                <h6 class='algoDescription'>Welcome to Sorting 📊</h6>
                <h6 class='algoDescription'><strong><em>{this.state.currentAlgorithm === -1 ? "Select an algorithm first." : this.state.descriptions[this.state.currentAlgorithm]}</em></strong></h6>
                <h5 class='algoComplexity' style={{marginTop: "65px", color:"rgb(90,90,90)"}}><strong>{
