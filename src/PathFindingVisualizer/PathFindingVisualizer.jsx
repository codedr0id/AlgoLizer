...
export default class PathFindingVisualizer extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            SR: 7,
            SC: 5,
            descriptions: ['BFS: This algorithm explores all the nodes at the present depth before moving on to the nodes at the next depth level.',
                           'Dijkstra: This is an algorithm for finding the shortest paths between nodes in a graph.',
                           'A Star: This algorithm efficiently plots a walkable path between multiple nodes or points, on the graph.',
                           'DFS: This algorithm starts at the root node and explores as far as possible along each branch before backtracking.'],
            speed: 'median',
    ...
    render() {
        ...
        return (
            <>
                ...
                <h6 class='algoDescription'>Welcome to PathFinder 🖇</h6>
